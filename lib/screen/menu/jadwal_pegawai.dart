    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          ...
          // If current selection is null and there's only one dept, select it.
          // Or if multiple, the first load already correctly fetched everything based on permissions.
          if (selectedDept == null && authorizedDepts.length == 1) {
            selectedDept = authorizedDepts[0]['id'].toString();
          }
        });
      }
    } catch (e) {
